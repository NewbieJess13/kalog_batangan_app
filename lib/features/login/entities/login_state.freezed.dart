...
class _$LoginStateImpl implements _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(email: $email, password: $password, rememberMe: $rememberMe, hidePassword: $hidePassword, status: $status, isValid: $isValid, errorMessage: $errorMessage)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, email, password, rememberMe,
      hidePassword, status, isValid, errorMessage);
